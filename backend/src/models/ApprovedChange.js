...
const approvedChangeSchema = new mongoose.Schema(
  {
    ...
    winning_proposal_id: { type: mongoose.Schema.Types.ObjectId, ref: 'LawChangeProposal', required: true },
    ...
    move_after_element_id: { type: mongoose.Schema.Types.ObjectId, ref: 'Element', default: null },
    votes_for_weighted: { type: Number, default: 0 },
    votes_against_weighted: { type: Number, default: 0 },
    iteration: { type: Number, default: 0 },
    supersedes_id: { type: mongoose.Schema.Types.ObjectId, ref: 'ApprovedChange', default: null },
    ...
    parent_element_id: { type: mongoose.Schema.Types.ObjectId, ref: 'Element', default: null },
