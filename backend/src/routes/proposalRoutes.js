 ...
 *     description: Дозволяє переглянути список законопроєктів із можливістю фільтрації за `lawId` або `userId`. Якщо фільтри не вказано, за замовчуванням повертаються законопроєкти поточного автентифікованого користувача.
 *     tags: [Proposals]
 *     security:
 *       - bearerAuth: []
 *     parameters:
