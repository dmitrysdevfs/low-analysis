  ...
  phases: [
    ...
    },
    {
      ...
      tasks: [
        ...
        { text: "Граф зв'язків між нормами різних законів", done: false },
        { text: '"Радіант" — 3D-візуалізація законодавчої бази', done: false },
        { text: "Повнотекстовий пошук на рівні бекенду", done: false },
      ],
    },
  ],
  roadmapItems: [
    ...
    { text: "Кодекси України: КУпАП, Цивільний, Кримінальний", done: false },
    { text: "Граф зв'язків між нормами різних законів", done: false },
    { text: '"Радіант" — 3D-візуалізація законодавчої бази', done: false },
  ],
  deferredItems: [
