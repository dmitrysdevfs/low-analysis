...
const faqItems: FaqItem[] = [
  ...
  {
    question: "Чим супервізер відрізняється від адміністратора?",
    answer:
      "Супервізер керує своєю групою та перевіряє роботи студентів, а адміністратор має повний контроль над платформою.",
  },
  {
