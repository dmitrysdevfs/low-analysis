...
export const ROLES_GUEST_FALLBACK = makeFallback(
  ...
  [
    ...
    },
    {
      ...
      style: { theme: "surface", spacingTop: "md", spacingBottom: "md", alignment: "left", background: "", accent: "", columns: "", hideOnMobile: false },
    },
    {
      id: "cta-roles-guest",
      type: "cta",
      ...
      style: { theme: "gold", spacingTop: "lg", spacingBottom: "xl", alignment: "left", background: "", accent: "", columns: "", hideOnMobile: false },
    },
  ],
);
  ...
  [
    {
      ...
      style: { theme: "navy-gold", alignment: "left", spacingTop: "xl", spacingBottom: "lg", background: "gradient-hero", accent: "", columns: "", hideOnMobile: false },
    },
    {
      id: "steps-roles-user",
      type: "steps",
      ...
      style: { theme: "muted", spacingTop: "md", spacingBottom: "md", alignment: "left", background: "", accent: "", columns: "", hideOnMobile: false },
    },
    {
      id: "cta-roles-user",
      type: "cta",
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          ...
          { question: "Скільки груп можна створити?", answer: "На поточному MVP до 10 активних груп. Обмеження встановлюється адміністратором." },
    ...
    },
    {
      ...
      data: {
        ...
        items: [
          ...
          { badge: "Laws", title: "Управління законами", body: "Додавання, редагування та парсинг нових законодавчих актів.", linkLabel: "Адмін", linkHref: "/admin" },
          { badge: "Audit", title: "Аудит і модерація", body: "Черга пропозицій і поправок на розгляд, скарги та лог дій.", linkLabel: "Аудит", linkHref: "/admin/audit" },
        ],
      },
      style: { theme: "surface", spacingTop: "md", spacingBottom: "xl", alignment: "left", background: "", accent: "", columns: "", hideOnMobile: false },
    },
  ],
);
...
export const SUPPORT_FALLBACK = makeFallback(
  ...
  [
    ...
    },
    {
      ...
      style: { theme: "muted", spacingTop: "md", spacingBottom: "xl", alignment: "left", background: "", accent: "", columns: "", hideOnMobile: false },
    },
  ],
);
