      ...
      <div className={styles.hero}>
        <div>
          ...
          <p className={styles.description}>
            ...
            активувати пробний тиждень, поновити щомісячний план і відстежувати
            квоти запитів — без збереження даних картки на бекенді.
          </p>
          ...
          <div className={styles.usageGrid}>
            <div className={styles.usageCard}>
              ...
              <div className={styles.usageMeta}>
                Пошук проходить через ті самі ліміт-гейти, що й у живому
                застосунку.
              </div>
            </div>
            ...
            <div className={styles.usageCard}>
              ...
              <div className={styles.usageMeta}>
                Дерева законів, статті та сторінки суб&apos;єктів витрачають цю
                квоту.
              </div>
            </div>
          </div>
