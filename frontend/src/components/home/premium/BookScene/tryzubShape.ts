...
export function makeTryzubShape(S = 0.14): THREE.Shape {
  ...
  s.lineTo( 1.20 * S, 2.2 * S);
  s.lineTo( 1.20 * S, 3.1 * S);
  s.lineTo( 1.45 * S, 2.9 * S);
  s.lineTo( 1.55 * S, 2.2 * S);
  s.lineTo( 1.80 * S, 2.2 * S);
  s.lineTo( 1.80 * S, 1.8 * S);
  s.lineTo( 1.55 * S, 1.8 * S);
  s.lineTo( 1.55 * S, 1.1 * S);
  s.lineTo( 1.80 * S, 1.1 * S);
  s.lineTo( 1.80 * S, 0.75 * S);
  s.lineTo( 1.55 * S, 0.75 * S);
  s.lineTo( 0.30 * S, 0.75 * S);
  s.lineTo( 0.30 * S, -0.40 * S);
  s.lineTo( 0.70 * S, -0.40 * S);
  s.lineTo( 0.70 * S, -0.85 * S);
  s.lineTo( 0,        -0.85 * S);
  // mirror left
  s.lineTo(-0.70 * S, -0.85 * S);
  s.lineTo(-0.70 * S, -0.40 * S);
