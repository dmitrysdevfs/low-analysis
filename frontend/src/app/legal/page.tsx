          ...
          <section id="privacy" className={styles.section}>
            ...
            <div className={styles.block}>
              ...
              <ul className={styles.list}>
                ...
                <li>
                  <strong>Пароль</strong> — хешується алгоритмом bcrypt та зберігається у захищеній базі даних MongoDB. Ніколи не зберігається у відкритому вигляді.
                </li>
                <li>
            ...
            <div className={styles.block}>
              ...
              <p>
                Персональні дані зберігаються у захищеній базі даних MongoDB. Автентифікація реалізована через JWT-токени з обмеженим терміном дії. Паролі хешуються bcrypt. Транспорт даних захищено протоколом HTTPS.
              </p>
            </div>
