        ...
        <div style={{ maxWidth: 860, margin: '0 auto', padding: '56px 24px 100px' }}>
          ...
          >
            ...
            <p style={{ fontSize: '0.95rem', color: '#7A98C0', margin: 0, maxWidth: 460, lineHeight: 1.65 }}>
              Структуровані тексти законів України — від лінійного полотна до ієрархічної бази атомарних елементів.
            </p>
          </motion.div>
          ...
          >
            <span style={{ position: 'absolute', left: 14, top: '50%', transform: 'translateY(-50%)', fontFamily: 'var(--font-mono)', fontSize: '0.8rem', color: '#4A80D4', pointerEvents: 'none' }}>
              ⌕
            </span>
            <input
              type="text"
            ...
            {query ? (
              <button
                onClick={() => setQuery('')}
                style={{ position: 'absolute', right: 12, top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', color: '#7A98C0', cursor: 'pointer', fontFamily: 'var(--font-mono)', fontSize: '0.8rem', padding: 4 }}
              >
                ✕
              </button>
            ) : null}
