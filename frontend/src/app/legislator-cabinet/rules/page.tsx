...
const CAPABILITIES = [
  ...
  },
  {
    ...
    text: "Координується з іншими учасниками та супервізером через історію, шаблони, групи й чат робочого кабінету.",
    icon: MessagesSquare,
  },
  {
...
const WORKFLOW = [
  ...
  },
  {
    ...
    text: "За потреби синхронізується з іншими учасниками й супервізером через чат, шаблони та історію.",
  },
  {
    step: "06",
...
const STATUS_RULES = [
  ...
  {
    title: "Review",
    text: "Зміна передана на перевірку супервізеру або в наступний етап процесу та очікує рішення.",
    icon: Eye,
  },
  {
    title: "Approved",
...
const UK_CONTEXT = [
  ...
  },
  {
    ...
    text: "Усі зміни повинні бути видимі, порівнювані та придатні для контролю з боку групи, супервізера та спільноти.",
    icon: Shield,
  },
] as const;
...
const FAQ = [
  ...
  },
  {
    ...
    answer:
      "Так, але найбільшу користь платформа дає у зв’язці з групою та супервізером, коли зміни проходять через колективне доопрацювання і перевірку.",
  },
  {
