    ...
    <section className={styles.page}>
      ...
      <div className={styles.roleCardsRow}>
        ...
        <div className={styles.supervisorCard}>
          <div className={styles.legislatorCardContent}>
            <span className={styles.supervisorEyebrow}>Супервізор</span>
            <h2 className={styles.legislatorTitle}>Панель нагляду</h2>
            <p className={styles.legislatorDescription}>
              {isSupervisor
                ? "Моніторинг платформи, звіти та операційний контроль."
                : "Подайте запит на роль супервізора для доступу до панелі нагляду."}
            </p>
          </div>
          <Link
            href={ROUTES.supervisorDashboard}
            className={styles.supervisorAction}
          >
            {isSupervisor ? "Відкрити панель" : "Подати запит"}
          </Link>
        </div>
      </div>
