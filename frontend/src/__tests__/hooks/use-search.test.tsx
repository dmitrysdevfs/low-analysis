...
describe('useSearch', () => {
  ...
  it('filters by type and sorts by title', async () => {
    vi.mocked(getLaws).mockResolvedValue([LAW_FIXTURE_3, LAW_FIXTURE, LAW_FIXTURE_2]);
  ...
  it('sorts by createdAt when requested', async () => {
    vi.mocked(getLaws).mockResolvedValue([LAW_FIXTURE, LAW_FIXTURE_2, LAW_FIXTURE_3]);
    ...
    expect(result.current.results).toEqual([LAW_FIXTURE_3, LAW_FIXTURE, LAW_FIXTURE_2]);
  });

  it('keeps server order for relevance sort', async () => {
    vi.mocked(getLaws).mockResolvedValue([LAW_FIXTURE_2, LAW_FIXTURE, LAW_FIXTURE_3]);
    ...
    expect(result.current.results).toEqual([LAW_FIXTURE_2, LAW_FIXTURE, LAW_FIXTURE_3]);
  });
